...
inline __device__ void FwdRad10B1_Pass0(unsigned int outOffset, unsigned int me, float *bufOutRe, float *bufOutIm,
																...
																float2 *R0, float2 *R1, float2 *R2, float2 *R3, float2 *R4, float2 *R5, float2 *R6, float2 *R7, float2 *R8, float2 *R9)
{
	if(rw)
	{
		...
		(*R0).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 0 )*stride_in];
		(*R1).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 1 )*stride_in];
		(*R2).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 2 )*stride_in];
		(*R3).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 3 )*stride_in];
		(*R4).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 4 )*stride_in];
		(*R5).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 5 )*stride_in];
		(*R6).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 6 )*stride_in];
		(*R7).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 7 )*stride_in];
		(*R8).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 8 )*stride_in];
		(*R9).x = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 9 )*stride_in];


		(*R0).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 10 )*stride_in];
		(*R1).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 11 )*stride_in];
		(*R2).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 12 )*stride_in];
		(*R3).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 13 )*stride_in];
		(*R4).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 14 )*stride_in];
		(*R5).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 15 )*stride_in];
		(*R6).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 16 )*stride_in];
		(*R7).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 17 )*stride_in];
		(*R8).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 18 )*stride_in];
		(*R9).y = ((float*)bufIn)[inOffset + ( 0 + me*1 + 0 + 19 )*stride_in];
	}

	FwdRad10B1_Pass0(outOffset, me, bufOutRe, bufOutIm, R0, R1, R2, R3, R4, R5, R6, R7, R8, R9);	
...
inline __device__ void FwdPass1_len100(const float2  *twiddles, 
																...
																float2 *bufOut, 
																float2*R0, float2*R1, float2*R2, float2*R3, float2*R4, float2*R5, float2*R6, float2*R7, float2*R8, float2*R9,
																float2 W1, float2 W2, float2 W3, float2 W4, float2 W5, float2 W6, float2 W7, float2 W8, float2 W9)
{
	{
		//float2  W;
		float TR, TI;
	...
	if(rw)
	{
		...
		((float*)bufOut)[outOffset + ( 1*me + 0 + 0 )*stride_out] = (*R0).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 1 )*stride_out] = (*R1).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 2 )*stride_out] = (*R2).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 3 )*stride_out] = (*R3).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 4 )*stride_out] = (*R4).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 5 )*stride_out] = (*R5).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 6 )*stride_out] = (*R6).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 7 )*stride_out] = (*R7).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 8 )*stride_out] = (*R8).x;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 9 )*stride_out] = (*R9).x;

		((float*)bufOut)[outOffset + ( 1*me + 0 + 10 )*stride_out] = (*R0).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 11 )*stride_out] = (*R1).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 12 )*stride_out] = (*R2).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 13 )*stride_out] = (*R3).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 14 )*stride_out] = (*R4).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 15 )*stride_out] = (*R5).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 16 )*stride_out] = (*R6).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 17 )*stride_out] = (*R7).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 18 )*stride_out] = (*R8).y;
		((float*)bufOut)[outOffset + ( 1*me + 0 + 19 )*stride_out] = (*R9).y;
	}	
}
...
__global__ void fft_fwd_op_len100( const uint32_t batch, 
														...
														float2 * gbIn, float2 * gbOut)
{
	...
	unsigned int batch_cnt = (unsigned int)hipBlockIdx_x;
	...
	unsigned int rw = (static_cast<int>(me) < (static_cast<int>(upper_count)  - static_cast<int>(batch_cnt)*12)*10) ? 1 : 0;
	unsigned int b = 0;

	size_t counter_mod = (batch_cnt*12 + (me/10));
	if(dim == 1)
	{
...
{	
	...
	std::cout << "gpu test\n";
	dim3 gp_sz = dim3(10, 6);
	dim3 gp_num = dim3(1, (batch+6-1)/6);
	hipLaunchKernelGGL(fft_fwd_op_len100, gp_num, gp_sz, 
					0, 0, 
					batch, dtw, x, y);
	...
	if(0)
	{
		...
		for(int i = 0;i<iteration_times;i++)
			hipLaunchKernelGGL(fft_fwd_op_len100, gp_num, gp_sz, 0, 0, batch, dtw, x, y);
